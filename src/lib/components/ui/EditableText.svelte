...
<style>
    ...
    .actions {
        display: flex;
        /*
         * 12, а не 4 (ACCESSIBILITY-v9 § 10.3.1, `A11Y-TOUCH-OVERLAP`).
         *
         * Кнопки тут 26 px, тобто менші за норматив 44. Заміряно 2026-09-11:
         * при 4 px проміжку зона однієї кнопки, розширена до 44×44, залазить
         * на сусідню на 5 px — тобто «олівець» і «кубик» відбирають дотики
         * один в одного там, де візуально нічого не змінилося. 12 px
         * розводять їх рівно настільки, щоб цього не сталося.
         */
        gap: 12px;
        opacity: 0.6;
