 ...
 *
 * Це не абстрактна повнота: до цього рефакторингу серія `R` жила прямо в
 * обробнику, і затиснута клавіша в полі пошуку витирала всі локальні дані за дві
 * секунди без запитання. Нижче — рівно ті обмеження, яких тоді не було.
 */
