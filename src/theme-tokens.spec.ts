 ...
 * темний фіолетовий бере їх із загального `[data-theme="dark"]`:
 *
 * | токен | фіолетове значення | що бере темний purple |
 * |---|---|---|
 * | `--piece-color` | `#a259e6` | `#ffd54f` — бурштиновий |
 * | `--control-hover` | `#a259e6` | `#1976d2` — синій |
 * | `--confirm-btn-hover` | `#7c3aed` | `#2e7d32` — зелений |
 * | `--no-moves-btn-hover` | `#e0c3fc` | `#f57c00` — оранжевий |
 * | `--cell-blocked` | `#b39ddb` | `#626262` |
 * | `--piece-shadow` | фіолетова | `rgba(0, 0, 0, 0.7)` |
 *
 * Тобто у фіолетовій темній темі фігури на дошці бурштинові, ховер синій, а
 * підтвердження зеленіє. Жоден гейт цього не бачив: кожен файл окремо
 * правильний, а дефект живе в РІЗНИЦІ наборів.
 *
