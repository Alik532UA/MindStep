...
export default ts.config(
	...
	...svelte.configs['flat/recommended'],
	{
		...
		rules: {
			...
			// 123 знахідки (було 140; заміряно `npx eslint . -f json` 2026-08-19).
			...
			// 167 знахідок (було 199; заміряно `npx eslint . -f json` 2026-08-19).
			...
			// 31 знахідка. `warn`: SVELTE-UI-v8 § 1.5 — each без ключа
			...
			// станом на 2026-08-19 разом це 360 попереджень і 0 помилок.
